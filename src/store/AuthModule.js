  ...
  actions: {
    ...
    sendMagicLink({ commit }, payload) {
      ...
      if (environment === "production") {
        ...
        MM_URL = 'https://www.mememaster.app/' // import.meta.env.VITE_APP_MM;
      } else if (environment === "testnet") {
        console.log("API TEST ENVIRONMENT");
        MM_URL = 'https://testnet.mememaster.app/' // import.meta.env.VITE_APP_MM_TEST;
      } else {
        console.log("API LOCAL ENVIRONMENT");
        MM_URL = 'https://www.mememaster.app/' // import.meta.env.VITE_APP_MM_LOCAL;
      }
